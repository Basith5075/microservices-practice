...
import com.getjobs.reviewms.review.messaging.ReviewMessageProducer;
...
public class ReviewController {
    ...
    public Double getAverageRatings(@RequestParam Long companyId){
        ...
        List<Review> list = reviewService.getAllReviewsByComp(companyId);
        return list.stream().mapToDouble(Review::getRating).average().orElse(0);
    }
}
